...
export const mixes: Mix[] = [
  {
    ...
    "description": "time reset without ceremony. days ahead, unmarked. made for open space and quiet planning.",
    "release_date": "TBD",
    "duration": "24:12",
    "music_url": "https://mixes.numa.channel/mixes/numa.009-empty_calendar.mp3",
    "youtube_url": "https://www.youtube.com/watch?v=QV24zp6nGO4",
    "colors": [
      "#f8f8f8",
      "#e8e8e8",
      "#c1d6e7"
    ...
    "tracks": [
      ...
      {
        "index": 7,
        "title": "first notation",
        "duration": "2:33",
        "timestamp": "14:56"
      },
      {
        "index": 8,
        "title": "light penciled",
        "duration": "2:22",
        "timestamp": "17:27"
      },
      {
